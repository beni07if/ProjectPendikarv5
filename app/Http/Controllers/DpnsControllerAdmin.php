...
class DpnsControllerAdmin extends Controller
{
    ...
    public function dpns1Homes()
    {
        ...
        // }
        // return $data_akhir;
        return view('koordinator.dpns.dpns1Homes', compact('data_akhir', 'mahasiswa'));
    }

    public function dpns2Homes()
    {
        // $user = $this->middleware('auth:admin');
        // // $eloquent = Mahasiswa::where(auth()->user()->keluarga)->get();
        // $mahasiswa = User::all();
        ...
        // }
        // return $data_akhir;
        return view('koordinator.dpns.dpns2Homes', compact('data_akhir', 'mahasiswa'));
    }

    public function dpns3Homes()
    {
        // $user = $this->middleware('auth:admin');
        // // $eloquent = Mahasiswa::where(auth()->user()->keluarga)->get();
        // $mahasiswa = User::all();
