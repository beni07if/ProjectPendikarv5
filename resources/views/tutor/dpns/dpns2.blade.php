            ...
            <div class="row mt-4">
              <nav class="w-100">
                <div class="nav nav-tabs" id="product-tab" role="tablist">
                  ...
                  <a class="nav-item nav-link active" id="product-comments-tab" href="" aria-controls="product-comments"
                    aria-selected="false">DPNS 2</a>
                ...
                <div class="tab-pane fade show active" id="product-desc" role="tabpanel"
                  ...
                  <div class="card-header">
                    ...
                    <?php
                                    ...
                                    $ujianKompetensi = (($nPeriodik->fardu_kifayah)+($nPeriodik->hafalan_doa)+($nPeriodik->baca_quran))/3;
                                    $aktivitasHarian = (($sholat)+($nPeriodik->dzikir)+($nPeriodik->tilawatil_quran))/3;
                                    $dpns22 = (($nPeriodik->kehadiran)+($tugasTerstruktur)+($ujianKompetensi)+($aktivitasHarian));
                                    ?>
                    @endforeach
                    @endif
                    <b>DPNS 2</b> <a class="float-right text-muted">{{ number_format($dpns22,2)/2 }}</a>
                  </div>
                </div>
              </div>
            </div>
