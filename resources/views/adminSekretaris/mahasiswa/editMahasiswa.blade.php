                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" onkeypress="return hanyaAngka(event)" class="form-control" id="no_hp"
                                    name="no_hp" {{$disabled}} value="{{ $mahasiswa->no_hp }}" required
                                    placeholder={{ $mahasiswa->no_hp }}>
                            </div>
                            <div class="form-group">
                                <label for="keluarga">Keluarga</label>
                                @if (Auth::check())
                                <input type="text" class="form-control" id="keluarga" name="keluarga" {{$disabled}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" name="foto" class="custom-file-input" {{$disabled}} required
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" onkeypress="return hanyaAngka(event)"
                                    id="periode" {{$disabled}} value="{{ $mahasiswa->periode }}" name="periode" required
                                    placeholder={{ $mahasiswa->periode }} readonly>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control select2" {{$disabled}} required="Minimal 0" name="role"
                                        style="width: 100%;">
