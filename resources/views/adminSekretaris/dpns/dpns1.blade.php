                                ...
                                <div class="tab-pane fade show active" id="product-desc" role="tabpanel"
                                    ...
                                    <table class="table table-striped table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            $dpns10 = ($kehadiran+$tugasTerstruktur+$ujianKompetensi+$aktivitasHarian+$bukuHarian);
                                            ?>
                                            <tr>
                                                {{--  <td>{{ $no }}</td> --}}
                                                ...
                                                <td>
                                                    <a href="{{ route('nilaiPeriodik.edit', $nPeriodik->id)}}"
                                                        type="button" class="btn btn-info btn-sm"><i class="fas fa-eye"></i> Detail</a>
                                    ...
                                    <div class="card-header">
                                        ...
                                        <?php
                                            ...
                                            $ujianKompetensi = ($farduKifayah+$hafalanDoa+$bacaQuran);
                                            $aktivitasHarian = ($shlt+$dzikr+$tilawah);
                                            $dpns11 = ($kehadiran+$tugasTerstruktur+$ujianKompetensi+$aktivitasHarian+$bukuHarian);
                                            $dpns1Hasil += $dpns11;
                                            ?>
                                        @endforeach
                                        @endif
                                        <b>Total | DPNS 1</b> <a
                                            class="float-right text-muted">{{ number_format($dpns1Hasil,2)}} |
                                            {{ number_format($dpns1Hasil,2)/4 }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
