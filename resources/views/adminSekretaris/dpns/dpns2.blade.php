                        ...
                        <div class="row mt-4">
                            <nav class="w-100">
                                <div class="nav nav-tabs" id="product-tab" role="tablist">
                                    <a class="nav-item nav-link " id="product-desc-tab" href="{{ route('dpns11') }}" role="tab"
                                    ...
                                    <a class="nav-item nav-link active" id="product-comments-tab" href=""
                                ...
                                <div class="tab-pane fade show active" id="product-desc" role="tabpanel"
                                    ...
                                    <table class="table table-striped table-responsive">
                                        ...
                                        <tbody>
                                           ...
                                           <?php
                                            ...
                                            $dpns20 = ($kehadiran+$tugasTerstruktur+$ujianKompetensi+$aktivitasHarian+$bukuHarian);
                                            ?>
                                            <tr>
                                                {{--  <td>{{ $no }}</td>  --}}
                                                ...
                                                <td>
                                                    <a href="{{ route('nilaiPeriodik.edit', $nPeriodik->id)}}" type="button" class="btn btn-sm btn-info btn-sm"><i class="fas fa-eye"></i> Detail</a>
                                                    {{--  <p class="btn btn-warning btn-sm"><a href="{{ route('editdpns1', $nPeriodik->id) }}">edit
                                                    </p> --}}
                                                    {{--  <a href="{{ route('dpns1.edit', $nPeriodik->id)}}"
                                                    type="button" class="btn btn-sm
                                                    btn-warning">Ubah</a> --}}
                                                    {{--  <p class="btn btn-danger btn-xs">delete</p>  --}}
                                                    {{--  <form action="{{ route('dpns1.destroy', $nPeriodik->id)}}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
                                    ...
                                    <div class="card-header">
                                        ...
                                        <?php
                                            ...
                                            $ujianKompetensi = ($farduKifayah+$hafalanDoa+$bacaQuran);
                                            $aktivitasHarian = ($shlt+$dzikr+$tilawah);
                                            $dpns22 = ($kehadiran+$tugasTerstruktur+$ujianKompetensi+$aktivitasHarian+$bukuHarian);
                                            $np += $dpns22;
                                            ?>
                                        @endforeach
                                        @endif
                                        <b>Total | DPNS 2</b> <a class="float-right text-muted">{{ number_format($np,2)}} | {{ number_format($np,2)/8 }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
