        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            <div class="text-center">
              <img class="profile-user-img img-fluid img-circle" src="{{ asset('foto/adminSekretaris/' . auth()->user()->foto) }}" alt="User profile picture">
            </div>
            ...
            <div class="row mt-4">
              <nav class="w-100">
                <div class="nav nav-tabs" id="product-tab" role="tablist">
                  ...
                  <a class="nav-item nav-link active" id="product-rating-tab" href="" aria-controls="product-rating"
                    aria-selected="false">DPNS 3</a>
                </div>
              </nav>
              <div class="tab-content p-3" id="nav-tabContent">
                <div class="tab-pane fade show active" id="product-desc" role="tabpanel"
                  ...
                  <table class="table table-striped table-responsive">
                    ...
                    <tbody>
                      ...
                      <?php
                        ...
                        $dpns30 = ($kehadiran+$tugasTerstruktur+$ujianKompetensi+$aktivitasHarian+$bukuHarian);
                        ?>
                      <tr>
                        {{--  <td>{{ $no }}</td>  --}}
                        ...
                        <td>
                          <a href="{{ route('nilaiPeriodik.edit', $nPeriodik->id)}}" type="button" class="btn btn-sm btn-info"><i class="fas fa-eye"></i> Detail</a>
                  ...
                  <div class="card-header">
                    ...
                    @endforeach
                    @endif
                    <b>Total | DPNS 3</b> <a class="float-right text-muted">{{ number_format($np,2) }} | {{ number_format($np,2)/12 }}</a>
                  </div>
                </div>
              </div>
            </div>
