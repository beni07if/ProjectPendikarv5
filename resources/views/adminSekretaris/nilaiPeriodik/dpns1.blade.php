        ...
        <div class="modal-content">
          ...
          <form method="POST" action="{{ route('nilaiPeriodik.store') }} "  >
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4">
                <select class="form-control select2" required="Minimal 0" name="mahasiswa_id" style="width: 100%;">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                  <select class="form-control select2" required="Minimal 0" name="keluarga" style="width: 100%;">
                    ...
                    @if (Auth::check())
                    @foreach($mahasiswa as $mhs)
                    <option required value="{{ $mhs->keluarga }}" >{{ $mhs->keluarga }}</option>
                    @endforeach
                    @endif
