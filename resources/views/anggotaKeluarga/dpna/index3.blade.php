                                    ...
                                    <?php
                                                        //kalkulasi sholat
                                                          ...
                                                          //end kalkulasi tilawah
                                                                        ...
                                                                        $dpna1 = (($nPeriodik->kehadiran)+($tugasTerstruktur)+($ujianKompetensi)+($aktivitasHarian)+($nPeriodik->buku_harian));
                                                                        ?>
                                    @endforeach
                                    @endif
                                    <b>DPNA</b> <a class="float-right text-muted">{{ number_format($dpna1,2)/17 }}</a>
                                </div>
                              </div>
                            </div>
                          </div>
