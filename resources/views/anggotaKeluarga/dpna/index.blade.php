...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>DPNA Mahasiswa, {{ Auth::user()->name }}</h1>
        </div>
        <div class="col-sm-6">
            ...
            <div class="card-body box-profile">
              ...
              <ul class="list-group list-group-unbordered mb-3">
                ...
                <li class="list-group-item">
                   ...
                   @endforeach
                   @endif
                    <b>DPNA</b> <a class="float-right text-muted">{{ number_format($dpns3,2)/2 }}</a>
                </li>
              </ul>
                  ...
                  <div class="card-body table-responsive">
                    ...
                    ?>
                      ...
                      <div class="card-header">
                        {{-- <a href="{{ route('detailDpns1') }}" class="btn btn-info float-right">Detail {{ number_format($dpns3,2)/2 }}</a> --}}
                        <b>DPNA</b> <a class="float-right text-muted">{{ number_format($dpns3,2)/2 }}</a>
                    </div>
                  </div>
                  <!-- /.card-body -->
