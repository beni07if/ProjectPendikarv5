                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('nilaiPeriodikDetailAnggota', $nPeriodik->id) }}" type="button" class="btn btn-info btn-sm fas fa-folder">Detail/dakperlu</a>
                                        {{--  <a href="{{ route('nilaiPeriodik.edit', $nPeriodik->id)}}" type="button" class="btn btn-warning btn-sm fas fa-edit">Edit</a>  --}}
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            {{--  <form action="{{ route('nilaiPeriodik.destroy', $nilaiPeriodik->id)}}" method="post">
                @csrf
                @method('DELETE')  --}}
                <div class="modal-header">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="submit" class="btn btn-success toastsDefaultSuccess">Save changes</button>
                </div>
            {{--  </form>  --}}
        </div>
        <!-- /.modal-content -->
