                            ...
                            <div class="modal-body">
                                ...
                                <div class="card-body">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="{{ $mahasiswa->name }}" required placeholder={{ $mahasiswa->name}} >
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="fakultas" name="fakultas" value="{{ $mahasiswa->fakultas }}" required placeholder={{ $mahasiswa->fakultas }}>
                                  </div>
                                  <div class="form-group">
                                    <label for="prodi">Program Studi</label>
                                    <input type="text" class="form-control" id="prodi" name="prodi" value="{{ $mahasiswa->prodi }}" required placeholder={{ $mahasiswa->prodi }}>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    @if (Auth::check())
                                    <input type="text" class="form-control" id="keluarga" name="keluarga" value="{{ $mahasiswa->keluarga }}" required placeholder={{ $mahasiswa->keluarga }} readonly>
                                    @endif
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    @if (Auth::check())
                                    <input type="text" class="form-control" id="periode" value="{{ $mahasiswa->periode }}" name="periode" required placeholder={{ $mahasiswa->periode }} readonly>
                                ...
                                <button type="submit" class="btn btn-info btn-sm swalDefaultEditMahasiswa">Save</button>
                                </div>
                              </form>
                            </div>
                        </div>
