                ...
                <div class="card">
                    ...
                    //kalkulasi sholat
                      ...
                      //end kalkulasi tilawah
                                    ...
                                    $dpns22 = (($nPeriodik->kehadiran)+($tugasTerstruktur)+($ujianKompetensi)+($aktivitasHarian)+($nPeriodik->buku_harian));
                                    ?>
                                        @endforeach
                                        @endif
                                        <b>DPNS 2</b> <a
                                            class="float-right text-muted">{{ number_format($dpns22,2)/8 }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
