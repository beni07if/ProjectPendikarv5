                ...
                <div class="tab-pane fade show active" id="product-desc" role="tabpanel"
                  ...
                  <div class="card-header">
                    ...
                    <?php
                                    ...
                                    $ujianKompetensi = (($nPeriodik->fardu_kifayah)+($nPeriodik->hafalan_doa)+($nPeriodik->baca_quran))/3;
                                    $aktivitasHarian = (($sholat)+($dzikir)+($saritilawah))/3;
                                    $dpns33 = (($nPeriodik->kehadiran)+($tugasTerstruktur)+($ujianKompetensi)+($aktivitasHarian)+($nPeriodik->buku_harian));
                                    ?>
                    @endforeach
                    @endif
                    <b>DPNS 3</b> <a class="float-right text-muted">{{ number_format($dpns33,2)/12 }}</a>
                  </div>
                </div>
              </div>
            </div>
