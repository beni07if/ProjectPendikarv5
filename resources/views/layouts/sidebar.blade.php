...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link elevation-4">
        <img src="{{ asset('assets/dist/img/Logo-Untan-Universitas-Tanjungpura-PNG.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            ...
            <li class="nav-item">
                <!-- <a href="{{ route('dpnaMhs') }}" class="nav-link"> -->
