                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p class="btn btn-warning btn-xs"><a href="{{ route('editNilaiPeriodik', $mhs->id) }}">edit</p>  --}}
                                         ...
                                         <a href="{{ route('pesanVsKoor') }}" class="btn btn-sm btn-info">Pesan</a>
                                    </td>
                                </tr>
                                @endforeach
                                @endif
            ...
            <div class="modal-body">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    @if (Auth::check())
                    <input type="text" class="form-control" id="Pengaduan" name="Pengaduan" value="{{ $mhs->Pengaduan }}" required placeholder="Masukan Pengaduan" readonly>
                    @endif
                  </div>
                  <div class="form-group">
