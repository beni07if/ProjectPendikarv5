...
<body style="background-color: #666666;">
            ...
            <div class="wrap-login100">
                <form class="login100-form validate-form" method="POST" action="{{ route('login') }}">
                    ...
                    <span class="login100-form-title p-b-33">
                        SISTEM PENILAIAN PENDIKAR<br>Login by <b>Sekretaris/Mahasiswa</b>
                    </span>
                    ...
                    <a href="" data-toggle="modal" data-target="#modal-registrasi-mahasiswa">Register Mahasiswa</a><br>

                    <div class="text-center p-t-46 p-b-20">
                        <span class="txt2">
                            login by <br> (mahasiswa / koordinator)
                        </span>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="no_hp" name="no_hp"
                                    onkeypress="return hanyaAngka(event)" required placeholder="">
                            </div>
                            {{--  <div class="form-group">
                                <label for="keluarga">Keluarga</label>
                                <input type="text" class="form-control" id="keluarga" name="keluarga"
                                    onkeypress="return hanyaAngka(event)" required placeholder="Keluarga">
                            </div>  --}}
                            <div class="form-group">
                                <label for="keluarga">Keluarga</label>
    ...
    <div class="modal fade" id="modal-registrasi-mahasiswa">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Register Mahasiswa</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{ route('register.mahasiswa.store') }} " enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="role">Role</label>
                                <input type="text" class="form-control" id="role" name="role" value="mahasiswa"
                                    placeholder="mahasiswa" readonly>
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <input id="password" type="password" class="form-control" name="password" required
