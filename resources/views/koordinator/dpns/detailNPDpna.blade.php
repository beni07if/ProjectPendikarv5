        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('nilaiPeriodikControllerAdminUpdate', $nPeriodik->id) }} " enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select class="form-control select2" style="width: 100%;" required="Minimal 0" name="user_id">
                                    @if (Auth::check())
                                    <option selected="selected" value="{{ $nPeriodik->user_id }}">{{$mahasiswa[0]->name}}</option>
                                    @endif
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select class="form-control select2" required="Minimal 0" name="keluarga" style="width: 100%;">
                                    @if (Auth::check())
                                    <option value="{{ $mahasiswa[0]->keluarga }}">{{$mahasiswa[0]->keluarga}}</option>
                                    @endif
                                </select>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control select2" style="width: 100%;" required="Minimal 0" name="pekan_ke">
                                        @if(Auth::check())
                                        <option selected value="{{ $nPeriodik->pekan_ke }}" required="Minimal 0" name="pekan_ke">{{ $nPeriodik->pekan_ke }}</option>
                                        @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <input type="date" required="Minimal 0" name="tanggal" class="form-control" data-inputmask-alias="datetime" value="{{ $nPeriodik->tanggal }}" data-inputmask-inputformat="yyyy-mm-dd" data-mask>
                                    </div>
                                </div>
                            </div>
                            <!-- /.row -->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" style="width: 100%;" required="Minimal 0" name="kehadiran">
                                            <option required="Minimal 0" name="kehadiran" selected="selected" value="{{ $nPeriodik->kehadiran }}">{{ $nPeriodik->kehadiran }}
                                            </option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" style="width: 100%;" required="Minimal 0" name="ukhuwah_islamiyah">
                                            <option required="Minimal 0" name="ukhuwah_islamiyah" selected="selected" value="{{ $nPeriodik->ukhuwah_islamiyah }}">
                                                {{ $nPeriodik->ukhuwah_islamiyah }}
                                            </option>
                                            <option required="Minimal 0" name="ukhuwah_islamiyah" value="0">Tidak Hadir
                                            </option>
                                            <option required="Minimal 0" name="ukhuwah_islamiyah" value="100">Hadir
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" style="width: 100%;" required="Minimal 0" name="ukhuwah_wathoniyah">
                                            <option required="Minimal 0" name="kehadiran" selected="selected" value="{{ $nPeriodik->ukhuwah_wathoniyah }}">
                                                {{ $nPeriodik->ukhuwah_wathoniyah }}
                                            </option>
                                            <option required="Minimal 0" name="ukhuwah_wathoniyah" value="0">Tidak Hadir
                                            </option>
                                            <option required="Minimal 0" name="ukhuwah_wathoniyah" value="100">Hadir
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" style="width: 100%;" required="Minimal 0" name="hafalan_doa">
                                            <option required="Minimal 0" name="hafalan_doa" selected="selected" value="{{ $nPeriodik->hafalan_doa }}">
                                                {{ $nPeriodik->hafalan_doa }}
                                            </option>
                                            <option name="hafalan_doa" value="0">0</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" style="width: 100%;" required="Minimal 0" name="fardu_kifayah">
                                            <option required="Minimal 0" name="fardu_kifayah" selected="selected" value="{{ $nPeriodik->fardu_kifayah }}">
                                                {{ $nPeriodik->fardu_kifayah }}
                                            </option>
                                            <option name="fardu_kifayah" value="0">0</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" required="Minimal 0" name="baca_quran" value="10" style="width: 100%;">
                                            <option required="Minimal 0" name="baca_quran" selected="selected" value="{{ $nPeriodik->baca_quran }}">
                                                {{ $nPeriodik->baca_quran }}
                                            </option>
                                            <option name="baca_quran" value="0">0</option>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="sholat_fardu" class="col-md-4 col-form-label text-md-right">{{ __('Sholat fardu') }}</label>

                                    <div class="col-md-6">
                                        <select class="form-control select2" style="width: 100%;" required="Minimal 0" name="sholat_fardu">
                                            <option required="Minimal 0" name="sholat_fardu" selected="selected" value="{{ $nPeriodik->sholat_fardu }}">
                                                {{ $nPeriodik->sholat_fardu }}
                                            </option>
                                            <option required="Minimal 0" name="sholat_fardu" value="0">0</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="integer" class="form-control" id="tilawatil_quran" required="Minimal 0" name="tilawatil_quran" value="{{ $nPeriodik->tilawatil_quran }}" placeholder="Jumlah Halaman.." onkeypress="return hanyaAngka(event)">
                                    </div>
                                </div>
                                <!-- /.row -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="integer" class="form-control" id="dzikir" required="Minimal 0" name="dzikir" value="{{ $nPeriodik->dzikir }}" placeholder="Jumlah Menit.." onkeypress="return hanyaAngka(event)">
                                    </div>
                                </div>
                                <!-- /.row -->
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" style="width: 100%;" required="Minimal 0" name="buku_harian">
                                            <option selected="selected" required="Minimal 0" name="buku_harian" value="{{ $nPeriodik->buku_harian }}">
                                                {{ $nPeriodik->buku_harian }}
                                            </option>
                                            <option name="buku_harian" value="0">0</option>
