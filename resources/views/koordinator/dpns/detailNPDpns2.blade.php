        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <!-- form start -->
                    <form method="POST" action="{{ route('nilaiPeriodikControllerAdminUpdate', $nPeriodik->id) }} "
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select class="form-control select2" style="width: 100%;" required="Minimal 0"
                                    name="user_id">
                                    {{-- @if(count($nPeriodik) > 0)
                                @foreach($nPeriodik as $nPeriodik)
                                <option value="{{ $nPeriodik->baca_quran }}">{{ $nPeriodik->baca_quran }}
                                    </option>
                                    @endforeach
                                    @else
                                    @endif --}}
                                    ...
                                    {{-- @foreach ($mahasiswa as $mhs) --}}
                                    {{-- @foreach ($nPeriodik->mahasiswas as $mhs) --}}
                                    {{-- @foreach ($mhs->NilaiPeriodik as $nP) --}}
                                    {{-- <option value="{{ $nP->id }}" required="Minimal 0"
                                    name="mahasiswa_id">{{ $mhs->name }}</option> --}}
                                    // <option value="{{ $mhs->id }}" required="Minimal 0" name="user_id">
                                        {{ $mhs->name }}</option>
                                    ...
                                    @foreach($mahasiswa as $mhs)
                                        @foreach ($mhs->NilaiPeriodik as $nP)
                                        <option value="{{ $nP->kehadiran }}" required="Minimal 0"
                                    name="mahasiswa_nim">{{ $nP->kehadiran }}</option>
                                    @endforeach
                                    @endforeach
                                    @endif --}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select class="form-control select2" required="Minimal 0" name="keluarga"
                                    style="width: 100%;">

                                    @if (Auth::check())
                                    {{--  @foreach($nPeriodik as $mhs)  --}}
                                    <option value="{{ $nPeriodik->keluarga }}">{{ $nPeriodik->keluarga }}
                                    </option>
                                    {{--  @endforeach  --}}
                                    @endif
                        ...
                        <div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control select2" style="width: 100%;" required="Minimal 0"
                                        ...
                                        {{-- @foreach($mahasiswa as $mhs)
                                        @foreach ($mhs->NilaiPeriodik as $nP)
                                        <option selected value="{{ $nP->pekan_ke }}" required="Minimal 0"
                                        name="pekan_ke">{{ $nP->pekan_ke }}</option> --}}
                                        <option selected value="{{ $nPeriodik->pekan_ke }}" required="Minimal 0"
                                            name="pekan_ke">{{ $nPeriodik->pekan_ke }}</option>

                                        {{-- @endforeach
                                        @endforeach --}}
                                        {{--  <option selected="selected" required="Minimal 0" name="pekan_ke" value="{{ $nPeriodik->pekan_ke }}">{{ $nPeriodik->pekan_ke }}
                                        </option> --}}
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <input type="date" required="Minimal 0" name="tanggal" class="form-control"
                                            data-inputmask-alias="datetime" value="{{ $nPeriodik->tanggal }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" style="width: 100%;" required="Minimal 0"
                                            name="kehadiran">
                                            <option required="Minimal 0" name="kehadiran" selected="selected"
                                                value="{{ $nPeriodik->kehadiran }}">{{ $nPeriodik->kehadiran }}
                                            </option>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" style="width: 100%;" required="Minimal 0"
                                            name="ukhuwah_islamiyah">
                                            <option required="Minimal 0" name="ukhuwah_islamiyah" selected="selected"
                                                value="{{ $nPeriodik->ukhuwah_islamiyah }}">
                                                {{ $nPeriodik->ukhuwah_islamiyah }}</option>
                                            <option required="Minimal 0" name="ukhuwah_islamiyah" value="0">Tidak Hadir
                                            </option>
                                            <option required="Minimal 0" name="ukhuwah_islamiyah" value="10">Hadir
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" style="width: 100%;" required="Minimal 0"
                                            name="ukhuwah_wathoniyah">
                                            <option required="Minimal 0" name="kehadiran" selected="selected"
                                                value="{{ $nPeriodik->ukhuwah_wathoniyah }}">
                                                {{ $nPeriodik->ukhuwah_wathoniyah }}</option>
                                            <option required="Minimal 0" name="ukhuwah_wathoniyah" value="0">Tidak Hadir
                                            </option>
                                            <option required="Minimal 0" name="ukhuwah_wathoniyah" value="10">Hadir
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" style="width: 100%;" required="Minimal 0"
                                            name="hafalan_doa">
                                            <option required="Minimal 0" name="hafalan_doa" selected="selected"
                                                value="{{ $nPeriodik->hafalan_doa }}">
                                                {{ $nPeriodik->hafalan_doa }}</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" style="width: 100%;" required="Minimal 0"
                                            name="fardu_kifayah">
                                            <option required="Minimal 0" name="fardu_kifayah" selected="selected"
                                                value="{{ $nPeriodik->fardu_kifayah }}">
                                                {{ $nPeriodik->fardu_kifayah }}</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" required="Minimal 0" name="baca_quran"
                                            ...
                                            <option required="Minimal 0" name="baca_quran" selected="selected"
                                                value="{{ $nPeriodik->baca_quran }}">
                                                {{ $nPeriodik->baca_quran }}</option>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" style="width: 100%;" required="Minimal 0"
                                            name="sholat_fardu">
                                            <option required="Minimal 0" name="sholat_fardu" selected="selected"
                                                value="{{ $nPeriodik->sholat_fardu }}">
                                                {{ $nPeriodik->sholat_fardu }}</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="integer" class="form-control" id="tilawatil_quran"
                                            required="Minimal 0" name="tilawatil_quran"
                                            value="{{ $nPeriodik->tilawatil_quran }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="integer" class="form-control" id="dzikir" required="Minimal 0"
                                            name="dzikir" value="{{ $nPeriodik->dzikir }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" style="width: 100%;" required="Minimal 0"
                                            name="buku_harian">
                                            <option selected="selected" required="Minimal 0" name="buku_harian"
                                                value="{{ $nPeriodik->buku_harian }}">
                                                {{ $nPeriodik->buku_harian }}</option>
