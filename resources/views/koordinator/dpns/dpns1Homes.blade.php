...
Daftar Peserta Nilai Akhir (DPNS 1) Mahasiswa Tahun 2021/2022
@endsection
                        ...
                        <table id="example1" class="table display table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('dpns1DetailKoordinator', $nilai->user_id) }}" type="button" class="btn btn-sm btn-info "><i class="fas fa-eye"></i> Detail DPNS 1</a>
