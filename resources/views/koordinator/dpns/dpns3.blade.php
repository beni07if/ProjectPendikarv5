        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            <div class="text-center">
              <img class="profile-user-img img-fluid img-circle" src="{{ asset('assets/images/pendikarv1/beni.png') }}"
                ...
                <div class="tab-pane fade show active" id="product-desc" role="tabpanel"
                  ...
                  <table class="table table-striped table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        {{--  <td>{{ ($aktivitasharian) }}</td>  --}}
                        <td>{{ $nPeriodik->buku_harian }}</td>
                        <td>{{ $nPeriodik->tanggal }}</td>
                        <td>
                          {{-- <a href="{{ route('dpns1.show', $nPeriodik->id)}}" type="button" class="btn btn-sm
                          btn-info">Detail</a> --}}
                  ...
                  <div class="card-header">
                    ...
                    <?php
                                    ...
                                    $ujianKompetensi = (($nPeriodik->fardu_kifayah)+($nPeriodik->hafalan_doa)+($nPeriodik->baca_quran))/3;
                                    $aktivitasHarian = (($sholat)+($dzikir)+($saritilawah))/3;
                                    $dpns33 = (($nPeriodik->kehadiran)+($tugasTerstruktur)+($ujianKompetensi)+($aktivitasHarian));
                                    ?>
                    @endforeach
                    @endif
                    <b>DPNS 3</b> <a class="float-right text-muted">{{ number_format($dpns33,2)/2 }}</a>
                  </div>
                </div>
              </div>
            </div>
