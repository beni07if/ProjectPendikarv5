                                ...
                                <div class="direct-chat-messages">
                                  ...
                                  <div class="direct-chat-msg">
                                    <div class="direct-chat-infos clearfix">
                                      ...
                                      <span class="direct-chat-timestamp float-right"><?php date_default_timezone_set('Asia/Jakarta'); echo date(' l, d-M-Y / h : i ') ?></span>
                                    </div>
                                    <!-- /.direct-chat-infos -->
                                    <img class="direct-chat-img" src="{{ asset('foto/adminSekretaris/' . auth()->user()->foto) }}" alt="Message User Image">
                                    <!-- /.direct-chat-img -->
