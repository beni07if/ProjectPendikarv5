                    ...
                    @endif
                     <!-- /.card-header -->
                            <div class="modal-body">
                                <form method="POST" action="{{ route('updateMhs', ['id' => $mahasiswa->id]) }} " enctype="multipart/form-data">
                                    @csrf
                                    {{--  @method('PUT')  --}}
                                <div class="card-body">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                      <select class="form-control select2"  required="Minimal 0" name="role" style="width: 100%;">
                                        ...
                                        <option value="mahasiswa">Anggota Keluraga</option>
                                ...
                                <button type="submit" class="btn btn-info btn-sm swalDefaultEditMahasiswa">Simpan</button>
                                </div>
                              </form>
                            </div>
                        </div>
